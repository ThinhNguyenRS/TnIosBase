...
public struct TnSliderField<TValue>: View where TValue : BinaryFloatingPoint & CVarArg, TValue.Stride : BinaryFloatingPoint {
    ...
    public init(value: Binding<TValue>, bounds: ClosedRange<TValue>, step: TValue.Stride, formatter: @escaping (TValue) -> String, onChanged: ((TValue) -> Void)? = nil, adjustBounds: Bool = false) {
        self.value = value
        self.bounds = bounds
        self.step = step
        self.formatter = formatter
